...
-- telescope
vim.api.nvim_set_keymap("n", "<leader>f " , "<cmd>lua require('telescope.builtin').resume()<cr>"     , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>ff" , "<cmd>lua require('telescope.builtin').find_files()<cr>" , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fg" , "<cmd>lua require('telescope.builtin').live_grep()<cr>"  , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fh" , "<cmd>lua require('telescope.builtin').help_tags()<cr>"  , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fj" , "<cmd>lua require('telescope.builtin').grep_string()<cr>", { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fo" , "<cmd>lua require('telescope.builtin').jumplist()<cr>"   , { noremap = true })
...
vim.api.nvim_set_keymap("n", "<leader>faf", "<cmd>lua require('setup.telescope').ff_home()<cr>"      , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fag", "<cmd>lua require('setup.telescope').lg_home()<cr>"      , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fsf", "<cmd>lua require('setup.telescope').ff_scratch()<cr>"   , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fsg", "<cmd>lua require('setup.telescope').lg_scratch()<cr>"   , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fdf", "<cmd>lua require('setup.telescope').ff_developer()<cr>" , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fdg", "<cmd>lua require('setup.telescope').lg_developer()<cr>" , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fcf", "<cmd>lua require('setup.telescope').ff_config()<cr>"    , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>fcg", "<cmd>lua require('setup.telescope').lg_config()<cr>"    , { noremap = true })

-- harpoon
vim.api.nvim_set_keymap("n", "<leader>ba", "<cmd>lua require('harpoon.mark').add_file()<cr>"       , { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>bb", "<cmd>lua require('harpoon.ui').toggle_quick_menu()<cr>", { noremap = true })
...
-- Browser Search
vim.api.nvim_set_keymap("n", "<leader>i", ":BrowserSearch<cr>"     , { noremap = true })
vim.api.nvim_set_keymap("v", "<leader>i", ":'<,'>BrowserSearch<cr>", { noremap = true })
