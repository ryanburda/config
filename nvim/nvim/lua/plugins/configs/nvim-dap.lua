...
function T.setup()
    ...
    vim.api.nvim_set_keymap('n', '<M-h>', "<cmd>lua require'dap'.toggle_breakpoint()<cr>", opts)
    ...
    vim.api.nvim_set_keymap('n', '<M-x>', "<cmd>lua require'dap'.clear_breakpoints()<cr>", opts)
