...
function T.setup()
    ...
    vim.keymap.set('n', "<leader>fv", "<cmd>lua require('telescope.builtin').help_tags()<cr>", {desc = "Search vim help"})
    vim.keymap.set('n', "<leader>fm", "<cmd>lua require('telescope.builtin').man_pages()<cr>", {desc = "Search man pages"})
