...
vim.keymap.set('n', '<leader><C-i>', ':tabprevious<cr>'    , opts)
vim.keymap.set('n', '<leader><C-o>', ':tabnext<cr>'        , opts)
vim.keymap.set('n', '<leader><C-k>', ':tabnew<cr>'         , opts)
vim.keymap.set('n', '<leader><C-j>', ':split<cr><C-w>j'    , opts)
vim.keymap.set('n', '<leader><C-l>', ':vsplit<cr><C-w>l'   , opts)
