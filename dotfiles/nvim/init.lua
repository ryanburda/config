...
vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(event)
        vim.keymap.set('n', '<leader>fd', require('telescope.builtin').lsp_definitions, {desc = 'LSP: jump to definition', buffer = event.buf})
        vim.keymap.set('n', '<leader>fr', require('telescope.builtin').lsp_references, {desc = 'LSP: jump to references', buffer = event.buf})
        vim.keymap.set('n', '<leader>fi', require('telescope.builtin').lsp_implementations, {desc = 'LSP: jump to implementations', buffer = event.buf})
        vim.keymap.set('n', '<leader>fs', require('telescope.builtin').lsp_document_symbols, {desc = 'Find: symbols in current document', buffer = event.buf})
